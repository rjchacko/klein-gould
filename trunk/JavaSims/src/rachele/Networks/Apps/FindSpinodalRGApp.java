...
//import rachele.curieWeissIsing.apps.FindSpinodalApp;
...
public class FindSpinodalRGApp extends Simulation{

	Grid grid = new Grid("Random Graph Ising Model");
	...
	public static void main(String[] args) {
		new Control(new FindSpinodalRGApp(), "Random Graph Find Spinodal");
	}

	public void load(Control c) {
		c.frameTogether("MC-RG Ising data",grid,magPlot,magSqPlot);
		params.add("Data Dir",new DirectoryValue("/home/erdomi/data/spinodal_find/RG/testRuns"));
		params.add("Random seed", 854);
		params.add("L", 1<<7);
	...
	public void run() {
		...
		int maxTimeChunk = (int)(maxTime/sim.dt);

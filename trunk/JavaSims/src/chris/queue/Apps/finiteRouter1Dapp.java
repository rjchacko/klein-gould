...
import chris.queue.finiteRouter1D;

public class finiteRouter1Dapp extends Simulation{

	Grid grid = new Grid("Buffers");
	int N;
	finiteRouter1D model;
	private static final boolean draw = true;

	public static void main(String[] args) {
		new Control(new finiteRouter1Dapp(), "1D Router Network");
	}
	...
	public void run() {
		...
		N     = params.iget("N");
		model = new finiteRouter1D(params); 

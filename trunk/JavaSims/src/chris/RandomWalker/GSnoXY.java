...
public class GSnoXY extends Simulation{
	...
	public static void main(String[] args) {
		new Control(new GSnoXY(), "Parameters");
	}
	...
	public void load(Control c) {
		...
		params.add("Bins", (int) 200);
		params.add("Walkers", (int) 1E9);
		params.add("Steps", (int) 15);
		params.add("lambda", new DoubleValue(0.56, 0.5, 1.));
		params.add("Status");
	}
...
//				updatePDF(local[jj]);
			...
			params.set("lambda", params.fget("lambda")+0.005);

...
public class SPNdilution extends Simulation{
	...
	public int L,la,lb;
	public int R;    //the interaction range
	public double M;
	public double NJ;
	...
	public static void main (String[] SPNdilution){
		new Control(new SPNdilution(), "Kang Liu's long range site-diluted ising model's nucleation" );
	}
	
	
	
	public void load(Control SPNdilution)
	{
	...
	public void Properh(IsingStructure ising, Random rand, double T, double minH, double maxH, double dH)  // output the time of nucleation for different h, threshold=90%
	{
		...
		String run="<T="+fmt.format(T*1000)+", L= "+fmt.format(L)+", R="+fmt.format(R)+", la= "+fmt.format(la)+", lb= "+fmt.format(lb)+", p= "+fmt.format(percent*1000)+", pb= "+bmt.format(biaspercent*1000)+">";
		String path = "/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/scanfield "+run+".txt";
		for(double field=maxH; field>minH; field-=dH)
		{
			String pic="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/pic/<H= "+fmt.format(field*1000)+">"+run;
			...
			int ss=0;
			for(ss=0; Evolution.magnetization>(Ms*0.0);ss++)
			{
				Evolution.MCS(T, -field, Erand, 1, dynamics);
				Job.animate();
				params.set("Emcs", ss);
	...
	public void Singlerun(IsingStructure ising, Random rand, double T, double H)
	{
		...
		String singlerun="<T="+fmt.format(T*1000)+", H="+fmt.format(H*1000)+", L= "+fmt.format(L)+", R="+fmt.format(R)+", la= "+fmt.format(la)+", lb= "+fmt.format(lb)+", p= "+fmt.format(percent*1000)+", pb= "+bmt.format(biaspercent*1000)+">";
		String singlepath = "/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/singlerun "+singlerun+".txt";
		String singlepic="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/singlerunpic/"+singlerun;
	...
	{
		String Irun="<T="+fmt.format(T*1000)+", H="+fmt.format(H*1000)+", L= "+fmt.format(L)+", R="+fmt.format(R)+", la= "+fmt.format(la)+", lb= "+fmt.format(lb)+", p= "+fmt.format(percent*1000)+", pb= "+bmt.format(biaspercent*1000)+">";
		String Ipath = "/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/Intervention log.txt";
		String Ipic="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/Interventionpic/<t= "+fmt.format(breakpoint)+">"+Irun;
		String Bpic="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/Breakpoint/"+Irun;
		String Dpic="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/Droplet/"+Irun;
	...
	public void Dropletdistribution(IsingStructure ising, double T, double H, int copies, double thresholdM)
	{
		...
		String Drun="<T="+fmt.format(T*1000)+", H="+fmt.format(H*1000)+", L= "+fmt.format(L)+", R="+fmt.format(R)+", la= "+fmt.format(la)+", lb= "+fmt.format(lb)+", p= "+fmt.format(percent*1000)+", pb= "+bmt.format(biaspercent*1000)+">";
		String Dpath = "/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/nucleation log.txt";
		String ddpic="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/map/"+Drun;
		String Npic="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/nucleationevents/"+Drun;
	...
	public void Multihistogram(IsingStructure ising, double T, double H, int runs, int copies, double thresholdM)
	{
		...
		String Mrun="<T="+fmt.format(T*1000)+", H="+fmt.format(H*1000)+", L= "+fmt.format(L)+", R="+fmt.format(R)+", la= "+fmt.format(la)+", lb= "+fmt.format(lb)+", p= "+fmt.format(percent*1000)+", pb= "+bmt.format(biaspercent*1000)+">"+"threshold= "+fmt.format(thresholdM*1000);
		String Mpath="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/Multihistogram/lifetime"+Mrun+".txt";
		//String MSDpath="/Users/liukang2002507/Desktop/simulation/CNTdilution/"+dynamics+"/Multihistogram/SDlifetime"+Mrun+".txt";
		String Mlog="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/Multihistogram/multihistogramlog.txt";
		String Mpic="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/Multihistogram/"+Mrun;
	...
	public void Singlehistogram(IsingStructure ising, double T, double H, int runs, double thresholdM, int DPseed)
	{
		...
		String Srun="<T="+fmt.format(T*1000)+", H="+fmt.format(H*1000)+", L= "+fmt.format(L)+", R="+fmt.format(R)+", la= "+fmt.format(la)+", lb= "+fmt.format(lb)+", p= "+fmt.format(percent*1000)+", pb= "+bmt.format(biaspercent*1000)+">"+"Seed= "+fmt.format(DPseed);
		String Spath="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/Singlehistogram/"+Srun+".txt";
		String Slog="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/Singlehistogram/singlehistogramlog.txt";
		String Spic="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/Singlehistogram/"+Srun;
	...
	public void Singlegrowth(IsingStructure ising, double T, double H, int runs, int DPseed, int thNumber)  //single realization of dilution, multiple runs, thNumber (default-6) is the total number of thresholds
	{
		...
		String Srun="<T="+fmt.format(T*1000)+", H="+fmt.format(H*1000)+", L= "+fmt.format(L)+", R="+fmt.format(R)+", la= "+fmt.format(la)+", lb= "+fmt.format(lb)+", p= "+fmt.format(percent*1000)+", pb= "+bmt.format(biaspercent*1000)+">"+"Seed= "+fmt.format(DPseed);
		String Spath="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/Singlegrowth/growth"+fmt.format(thNumber)+Srun+".txt";
		String Slog="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/Singlegrowth/singlegrowthlog.txt";
		String Spic="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/Singlegrowth/"+Srun;
		...
		for(int rr=0; rr<runs; rr++)
		{
			...
			double Ms=totalM/10;    //calculate the saturate magnetization
			params.set("H", -H);//flip the field;
			int ss=0;     //actually is 20MCS step after the field flip, won't matter for long lived metastable states
			int tempin=0;
	...
	public void Multigrowth(IsingStructure ising, double T, double H, int copies, int thNumber)  //single realization of dilution, multiple runs, thNumber (default-6) is the total number of thresholds
	{
		...
		String Mrun="<T="+fmt.format(T*1000)+", H="+fmt.format(H*1000)+", L= "+fmt.format(L)+", R="+fmt.format(R)+", la= "+fmt.format(la)+", lb= "+fmt.format(lb)+", p= "+fmt.format(percent*1000)+", pb= "+bmt.format(biaspercent*1000)+">";
		String Mpath="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/Multigrowth/growth"+fmt.format(thNumber)+Mrun+".txt";
		String Mlog="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/Multigrowth/Multigrowthlog.txt";
		String Mpic="/Users/liukang2002507/Desktop/simulation/SPNdilution/"+dynamics+"/Multigrowth/"+Mrun;

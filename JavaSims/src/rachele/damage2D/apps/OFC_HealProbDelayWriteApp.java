...
public class OFC_HealProbDelayWriteApp extends Simulation{
	...
	public static void main(String[] args) {
		new Control(new OFC_HealProbDelayWriteApp(), "OFC Heal Probability Model");
	}
	...
	public void load(Control c) {
		...
		params.addm("Heal Probability", 0.0001);
...
//		System.out.println(ofc.noFails[0] + "  " + ofc.noFails[1] + " " + ofc.noFails[2]);
	...
	public void run() {
		ofc = new OFC_DamageLattice(params, "healProb");
		initFiles();
	...
	void initFiles(){
		...
		FileUtil.initFile(iMetFile, params, " heal prob app:  time (plate updates), stress inverse metric, time/coarse grained time, coarse grained activity inverse metric, coarse grained stress inverse metric, cg size act inverse metric");

...
public class GeometricStepsdDLoop extends Simulation{
	...
	public static void main(String[] args) {
		new Control(new GeometricStepsdDLoop(), "Parameters");
	}
...
//				updatePDF(local[jj]);
			...
			params.set("Dimension", params.iget("Dimension")+1);
...
//		local = new double[walkers][2];
		fout  = outdir + File.separator + tmp + "_" + dim +".txt";
		pfile = outdir + File.separator + "Params_" + tmp + "_" + dim  + ".txt";

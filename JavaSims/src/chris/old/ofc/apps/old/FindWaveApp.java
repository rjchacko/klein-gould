package chris.old.ofc.apps.old;
...
public class FindWaveApp extends Simulation {
	...
	public static void main(String[] args) {
		new Control(new FindWaveApp(), "OFC Model");
	}
	...
	public void run() {
	    ...
	    Color[] Carray = new Color[5];
	    
	    Carray[0] = Color.WHITE;
	    Carray[1] = Color.RED;
	    Carray[2] = Color.GREEN;
	    Carray[3] = Color.BLUE;
	    Carray[4] = Color.BLACK;
		
		
		for (int i = 0 ; i <= max ; i++){
			palette1.setColor(max - i,Carray[i%Carray.length]);
		}

...
public class fastEqCgApp extends Simulation{
	...
	private ofc2DfastCG model;
	
	public static void main(String[] args) {
		new Control(new fastEqCgApp(), "OFC Parameters");
	}
	...
	public void run() {
		...
		if((simt-1)%ofc2Dfast.dlength != 0){
			model.writeData(simt);
			model.writeCGdata(simt);
		}

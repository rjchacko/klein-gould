...
public class XML {
  // static constants
  public static String NEW_LINE = "/n";               //$NON-NLS-1$
  ...
  public static boolean requiresCDATA(String text) {
    if((text.indexOf("\"")!=-1)||(text.indexOf("<")!=-1)||(text.indexOf(">")!=-1)||(text.indexOf("&")!=-1)||(text.indexOf("'")!=-1)) { //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
      return true;
    }
    return false;
  }

...
public class XMLControlElement implements XMLControl {
  ...
  public void setValue(String name, boolean value) {
    ...
    setXMLProperty(name, "boolean", String.valueOf(value)); //$NON-NLS-1$
  }
  ...
  public void setValue(String name, double value) {
    ...
    setXMLProperty(name, "double", String.valueOf(value)); //$NON-NLS-1$
  }
  ...
  public void setValue(String name, int value) {
    ...
    setXMLProperty(name, "int", String.valueOf(value)); //$NON-NLS-1$
  }
   ...
   *
   * @param true to require password verification for file decryption
   */
  ...
  private Object arrayValue(String arrayString, Class<?> componentType) {
    ...
    if(componentType.isArray()) {
      ...
      String opening = "";                          //$NON-NLS-1$
      String closing = "";                          //$NON-NLS-1$
      for(int n = 0; ; n++) {
        if(trimmed.substring(n, n+1).equals("{")) { //$NON-NLS-1$
          opening += "{";                           //$NON-NLS-1$
          closing += "}";                           //$NON-NLS-1$
        } else {
          break;
  ...
  private Object collectionValue(XMLProperty prop) {
    ...
    try {
      ...
      Collection<Object> c = (Collection) classType.newInstance();

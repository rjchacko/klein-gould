...
public class FunctionEditor extends JPanel implements PropertyChangeListener {
  ...
  protected void refreshGUI() {
    ...
    if((border!=null)&&(border instanceof TitledBorder)) {
      ((TitledBorder) border).setTitle(ToolsRes.getString("FunctionEditor.Border.Title"));            //$NON-NLS-1$
    } else {
  ...
  private String getValidName(String proposedName) {
    ...
    while(!invalid.isEmpty()) {
      ...
      Object input = JOptionPane.showInputDialog(FunctionEditor.this, ToolsRes.getString("FunctionEditor.Dialog.InvalidName.Message"), //$NON-NLS-1$
  ...
  private ArrayList<String> getInvalidTokens(String name) {
    ...
    String[] suspects = new String[] {" ", "*", "+", //$NON-NLS-1$  //$NON-NLS-2$ //$NON-NLS-3$
